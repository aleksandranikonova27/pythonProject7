...
# admin.add_view(ModelView(Admins, db_session, name='Админы'))
# admin.add_view(ModelView(Media, db_session, name='Медиа'))
# admin.add_view(ModelView(Order, db_session, name='Заявки'))
